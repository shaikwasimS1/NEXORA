    ...
    >
      ...
      <div className="relative mx-auto max-w-[560px] flex-1 flex flex-col justify-center py-16 px-5">
        ...
        <div className="mb-7 flex items-center justify-center gap-3">
          <div
            ...
            style={{
              background:
                'linear-gradient(90deg,transparent,rgba(100,80,255,0.5))',
            }}
          />

          <span className="text-[10px] tracking-[4px] text-white/30 uppercase">
            Get in touch
          </span>
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(90deg,rgba(100,80,255,0.5),transparent)',
            }}
          />
        </div>
        ...
        <div className="mb-12 text-center">
          ...
          >
            ...
            <span
              style={{
                background:
                  'linear-gradient(135deg,#7df9ff,#9b59ff 50%,#ff6fd8)',
        ...
        >
          <div
            style={{
              ...
              height: 40,
              background:
                'radial-gradient(ellipse,rgba(120,80,255,0.35) 0%,transparent 70%)',
              filter: 'blur(12px)',
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(160deg,rgba(22,18,45,0.98) 0%,rgba(12,10,28,0.98) 100%)',
              border:
                '1px solid rgba(255,255,255,0.08)',
              borderTop:
                '1px solid rgba(255,255,255,0.14)',
              boxShadow:
                '0 32px 80px rgba(0,0,0,0.7),0 0 0 1px rgba(120,80,255,0.1) inset,0 1px 0 rgba(255,255,255,0.12) inset',
            }}
          >
            {/* Top Line */}
            <div
              ...
              style={{
                background:
                  'linear-gradient(90deg,transparent,rgba(150,100,255,0.6) 30%,rgba(0,220,200,0.6) 70%,transparent)',
              }}
            />
            ...
            {isSubmitted ? (
              <div className="py-8 text-center">
                ...
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg,rgba(120,255,200,0.15),rgba(100,80,255,0.15))',
                    border:
                      '1px solid rgba(120,255,200,0.3)',
                    animation:
                      'pulseRing 2s ease-out',
                  }}
                >
                  <svg
                    width="28"
      ...
      <style>{`
        ...
        .field-input:focus {
          ...
          box-shadow:
            0 0 0 3px rgba(120,80,255,0.12),
        ...
        @keyframes pulseRing {
          0% {
            box-shadow: 0 0 0 0 rgba(120,255,200,0.4);
          }

          100% {
            box-shadow: 0 0 0 24px rgba(120,255,200,0);
          }
        }
...
//           box-shadow:
//             0 12px 40px rgba(130,80,255,0.4),
